...
% Formatting packages
\usepackage{a4wide, fancyhdr, titlesec, lipsum, ragged2e, microtype, thmtools, ccicons, needspace, setspace, framed} % paralist, framed, layouts % unused
...
\declaretheoremstyle[
	...
	bodyfont		= \leftskip=2em \rightskip=2em \itshape \rmfamily \linespread{1.05}, % Body font and formatting
...
\declaretheoremstyle[
	...
	preheadhook		= \Needspace*{4\baselineskip},%\begin{center},	% Hook before the head; using needspace to ensure the head of the example is not on a separate page to its body.
	postheadspace	= 10pt							% Space after the head
	]{algorstyle}

\declaretheorem[style=algorstyle, shaded={textwidth=30em, rulecolor={rgb}{0,0,0}, rulewidth=1pt, bgcolor={rgb}{1,1,1}}, numberwithin=section]{algorithm}

\newtheorem{question}[theorem]{Question}
\newtheorem{interview}[theorem]{Interview Excerpt}


% Define the Maxima language for use in code listings

\lstdefinelanguage{Maxima}{
keywords={block,for,thru,do,kill,addrow,addcol,zeromatrix,ident,augcoefmatrix,ratsubst,diff,ev,tex,%
with_stdout,nouns,express,depends,load,submatrix,div,grad,curl,%
rootscontract,solve,part,assume,sqrt,integrate,abs,inf,exp,is,if,not,else,return,then,(,),[,]},
sensitive=true,
comment=[n][\itshape\color{dgreencolor}]{/*}{*/},
string=[b]"
}
\lstset{
  frame=none,
...
% A many basic mathematics commands
...
\newcommand{\fp}{\F[x_1,\ldots,x_n]}

\newcommand{\lt}{\mathrm{lt}}
\newcommand{\lc}{\mathrm{lc}}
\newcommand{\lp}{\mathrm{lp}}
\newcommand{\mlt}{\mathrm{Lt}}
\newcommand{\lcm}{\mathrm{lcm}}

\newcommand{\gb}{Gr\"{o}bner basis}
\newcommand{\gbs}{Gr\"{o}bner bases}

\newcommand{\<}{\langle}
\renewcommand{\>}{\rangle}

\newcommand{\bbeta}{\mathbfup\beta}
\newcommand{\balpha}{\mathbfup\alpha}

\newcommand{\bs}[1]{\mathbfup#1}
